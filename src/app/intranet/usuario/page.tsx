...
export default function Usuario() {
	...
	return (
		<div className="w-full mx-auto bg-white rounded-lg shadow p-6 space-y-6 relative">
			{/* Banner verde */}
			<div className="bg-green-500 h-32 rounded-md mb-[150px]" />

			{/* Avatar e información básica */}
			<div className="flex flex-col items-center space-y-2 -mt-16 absolute top-[80px] left-[100px] ">
			...
			<div className="space-y-4">
				...
				<div className="grid grid-cols-2 gap-4">
					...
					<div>
						<label className="block text-xs text-black pl-2 pb-2">Cargo</label>
						<input
							value="Vendedor"
							disabled
							className="w-full bg-gray-100 rounded px-3 py-2 capitalize"
